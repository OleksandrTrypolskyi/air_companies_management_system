...
import com.example.air_companies_management_system.exception.*;
...
public class ExceptionHandlerController {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(value = FlightStatusNotFoundException.class)
    public @ResponseBody
    ErrorInfo flightStatusNotFoundException(HttpServletRequest req, Exception ex) {
        return new ErrorInfo(req.getRequestURL().toString(), ex);
    }
}
